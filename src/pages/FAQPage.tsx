...
const FAQPage = () => {
  ...
  const faqCategories = {
    general: [
      {
        question: "What is Bhagavad Wisdom?",
        answer: "Bhagavad Wisdom is a platform that provides spiritual guidance based on the teachings of Bhagavad Gita. We offer features like problem solving advice, dream interpretation, daily mantras, and personalized affirmations based on ancient wisdom adapted for modern life challenges."
      },
      {
      ...
      {
        question: "How can I get the most benefit from Bhagavad Wisdom?",
    ...
    account: [
      ...
      },
      {
        ...
        answer: "Yes, you can access your Bhagavad Wisdom account from any device with a web browser. Your favorites and settings will sync across all your devices automatically."
      }
    ],
    premium: [
      {
    ...
    features: [
      ...
      },
      {
        ...
        answer: "Absolutely! We welcome user feedback and suggestions. Please visit our Contact page to share your ideas for improving Bhagavad Wisdom or adding new features that would enhance your spiritual journey."
      }
    ]
  };
  ...
  return (
    <PageLayout
      ...
      description="Find answers to common questions about Bhagavad Wisdom and its features."
    >
